            ...
            <div className="contactme-container">
                ...
                {status && renderAlert()}
                    ...
                    <div className="row">
                        <div className="input-group">
                            ...
                            value={values.name} onChange={handleChange}
                             ...
                             <FontAwesomeIcon icon={solid ('user')} />  Name</label>
                    ...
                    <div className="input-group">
                        ...
                        <label htmlFor="emailaddress" className="contact_label email-message"> <FontAwesomeIcon icon={solid ('envelope')} /> Email Address</label>
                    </div>  
                     {/* <!-- Message --> */}
                    <div className="input-group">
                        <textarea name="message"rows="8" id="message" value={values.message} onChange={handleChange} required></textarea> 

                        <label id="message" htmlFor="message" className="contact_label"> <FontAwesomeIcon icon={solid ('comments')}/> Your Message</label>
                    </div>
                    {/* <!-- Button Submit --> */}
                    <div className="button-group">
                        <button className="submitbtn" type='submit'>Submit <FontAwesomeIcon icon={solid ('paper-plane')}/> </button>
                    </div>
                    </div>
                    </form>
                </div>
